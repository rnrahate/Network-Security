...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.data_transformation_dir: str = os.path.join(training_pipeline.ARTIFACT_DIR, training_pipeline.DATA_TRANSFORMATION_DIR_NAME)
        ...
        self.preprocessor_object_file_path: str = os.path.join(self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DIR, training_pipeline.PREPROCESSING_OBJECT_FILE_NAME)

class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.model_trainer_dir: str = os.path.join(training_pipeline.ARTIFACT_DIR, training_pipeline.MODEL_TRAINER_DIR_NAME)
        ...
        self.overfitting_underfiitting_threshold: float = training_pipeline.MODEL_TRAINER_OVERFIITING_UNDERFITTING_THRESHOLD